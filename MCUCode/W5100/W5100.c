...
uint16 W5100ReadTCP(struct W5100Context_t *context, uchar socket, uchar** buffptr)
{
    uint16 size = 0;
    uint16 offset = 0;
    uint16 startAddr = 0;
...
uint16 W5100ReadUDP(struct W5100Context_t *context, uchar socket, uchar** buffptr)
{
    uint16 size = 0;
    uint16 offset = 0;
    uint16 startAddr = 0;
    ...
    // allocate the size for the buffer
    *buffptr = malloc(size);
    buff = *buffptr;
...
uint16 W5100ReadMulti(struct W5100Context_t *context, uchar socket, uchar** buff)
{
    ...
    return W5100ReadUDP(context, socket, buff);
}
