...
public:
 	...
 	// ----------------------------- Register Configuration --------------------------------
        ...
        // + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
        // + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x00 | R/W | CFGA |  TS   |   MA( 1:0 )   |   DO( 2:0 )           |  MS( 1:0 )    |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x01 | R/W | CFGB |   GN( 2:0 )           |   0   |   0   |   0   |   0   |   0   | 
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0X02 | R/W | MODE |  HS   |   0   |  LP   |   -   |   0   |  SIM  |  MD( 1:0 )    |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x03 |  R  | XMSB |        DXRA( 15:8 )                                           |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x04 |  R  | XLSB |        DXRA(  7:0 )                                           |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x05 |  R  | YMSB |        DYRA( 15:8 )                                           |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x06 |  R  | YLSB |        DYRA(  7:0 )                                           |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x07 |  R  | ZMSB |        DZRA( 15:8 )                                           |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x08 |  R  | ZLSB |        DZRA(  7:0 )                                           |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x09 |  R  | STAT |   -   |   -   |   -   |  DOW  |   -   |   -   |  LOCK |  RDY  |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x0A |  R  | ID A |      ASCII 'H'                                                |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x0B |  R  | ID B |      ASCII '4'                                                |
	...
	// | 0x0C |  R  | ID C |      ASCII '3'                                                |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x31 |  R  | TMSB |      TEMP( 15:8 )                                             |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x32 |  R  | TLSB |      TEMP(  7:0 )                                             |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
...
public:
	...
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x00 |  R  | XOUT |   -   | Alert |       XOUT( 5:0 )                             |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x01 |  R  | YOUT |   -   | Alert |       YOUT( 5:0 )                             |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x02 |  R  | ZOUT |   -   | Alert |       ZOUT( 5:0 )                             |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x03 |  R  | TILT | Shake | Alert |  Tap  |   PoLa( 2:0 )         | BaFro( 1:0 )  |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x04 |  R  | SRST |   0   |   0   |   0   |   0   |   0   |   0   | AWSRS | AMSRS |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x05 | R/W | SPCNT|               SC( 7:0 )                                       |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x06 |     | INTSU| SHINTX| SHINTY| SHINTZ|  GINT | ASINT | PDINT | PLINT | FBINT |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x07 | R/W | MODE |  IAH  |  IPP  |  SCPS |  ASE  |  AWE  |  TON  |   -   |  MODE |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x08 | R/W |  SR  |    FILT( 2:0 )        |  AWSR( 1:0 )  |   AMSR( 2:0 )         |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x09 | R/W | PDET |  ZDA  |  YDA  |  XDA  |        PDTH( 4:0 )                    |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	// | 0x0A | R/W |  PD  |               PD( 7:0 )                                       |
	// + ---- + --- + ---- + ----- + ----- + ----- + ----- + ----- + ----- + ----- + ----- +
	
	
	MMA7660FCAccelerometer() : m_XByte(0), m_YByte(0), m_ZByte(0), I2CDevice() {}
